...
class NewAllProductModel {
  ...
  NewAllProductModel.fromJson(dynamic json) {
    _error = json['error'];
...
NewAllProductModel copyWith({  bool? error,
  List<Product>? product,
  List<ProductVariant>? productVariant,
}) => NewAllProductModel(  error: error ?? _error,
