...
GetProductDetailsModel copyWith({  bool? error,
  List<Product>? product,
  List<ProductVariant>? productVariant,
}) => GetProductDetailsModel(  error: error ?? _error,
