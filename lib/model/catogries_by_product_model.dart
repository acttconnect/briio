...
class CatogriesByProductModel {
  CatogriesByProductModel({
      bool? error, 
  ...
  CatogriesByProductModel.fromJson(dynamic json) {
    _error = json['error'];
...
CatogriesByProductModel copyWith({  bool? error,
  List<Product>? product,
  List<ProductVariant>? productVariant,
}) => CatogriesByProductModel(  error: error ?? _error,
