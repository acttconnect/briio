...
class GetNewAddCartModel {
  ...
  GetNewAddCartModel.fromJson(dynamic json) {
    _error = json['error'];
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
  ...
  List<Data>? _data;
  String? _message;
GetNewAddCartModel copyWith({  bool? error,
  List<Data>? data,
  String? message,
}) => GetNewAddCartModel(  error: error ?? _error,
  data: data ?? _data,
...
/// quantity : "1"
/// created_at : "2022-07-09T18:06:15.000000Z"
/// updated_at : "2022-07-09T18:06:15.000000Z"
