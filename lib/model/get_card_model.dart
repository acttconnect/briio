/// error : false
/// data : [{"id":3,"userid":"32","productid":"2","productvariationid":2,"quantity":"1","created_at":"2022-04-26T12:26:59.000000Z","updated_at":"2022-04-26T12:26:59.000000Z","products":{"id":2,"name":"Product 2","category_id":1,"subcategory_id":2,"image":"22-03-23-1194213380.jpg","brand_id":2,"other_image":"[\"22-03-23-164801327587.jpg\"]","description":"Description 1","short_desc":"ABC","status":1,"created_at":"2022-03-23T05:27:55.000000Z","updated_at":"2022-03-23T05:48:40.000000Z"}},{"id":4,"userid":"32","productid":"2","productvariationid":2,"quantity":"1","created_at":"2022-06-28T11:37:22.000000Z","updated_at":"2022-06-28T11:37:22.000000Z","products":{"id":2,"name":"Product 2","category_id":1,"subcategory_id":2,"image":"22-03-23-1194213380.jpg","brand_id":2,"other_image":"[\"22-03-23-164801327587.jpg\"]","description":"Description 1","short_desc":"ABC","status":1,"created_at":"2022-03-23T05:27:55.000000Z","updated_at":"2022-03-23T05:48:40.000000Z"}}]
...
class GetCardModel {
  ...
  GetCardModel.fromJson(dynamic json) {
    _error = json['error'];
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
  ...
  List<Data>? _data;
  String? _message;
GetCardModel copyWith({  bool? error,
  List<Data>? data,
  String? message,
}) => GetCardModel(  error: error ?? _error,
  data: data ?? _data,
...
/// quantity : "1"
/// created_at : "2022-04-26T12:26:59.000000Z"
/// updated_at : "2022-04-26T12:26:59.000000Z"
